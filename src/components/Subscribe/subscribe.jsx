...
const Subscribe = () => {
  ...
  return (
 <div>
    <h2 className="animatedHeader" style={{ animation: 'slideIn 0.5s ease-in-out forwards', marginLeft: '23rem',marginBottom:"1rem",fontSize:"1.5rem",marginTop:"10%"}}>Welcome:)</h2>
      <h2 className="animatedHeader" style={{ color: "rgba(0, 0, 0, 0.5)", fontWeight: "normal", opacity: 0.8, animation: "slideIn 0.5s ease-in-out forwards" , marginLeft: '23rem' }}>
      To join our community, fill in your email below,
    </h2>
        <form className={`subscription ${isSubscribed ? 'done' : ''}`}>
          <input className="add-email" type="email" placeholder="subscribe@me.now" />
          <button className="submit-email" type="button" onClick={handleSubscribe}>
